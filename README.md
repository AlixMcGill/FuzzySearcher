...
<p align="center">Although I have definitely made a few mistakes in this project, the knowledge I've gained because of that is invaluable. This is essentially the first CRUD app I've created, and I've never utilized .NET before this project, but it has brought me to another level of confidence and shown me issues within my own knowledge that I did not perceive beforehand. I am always excited to see what I can learn with each project I create, and this one is no exception.</p>
<p align="center">Please feel free to flame my code; critique is always welcome. 😊</p>
